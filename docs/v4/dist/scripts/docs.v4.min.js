// // Write HTML but render escaped
// function escapeHTML() {
//   var els = document.querySelectorAll(".xml");
...
//     }
//     els[i].innerHTML = replaceText(els[i].innerHTML);
//   }
// }
// escapeHTML();

// Escape HTML and remove unwanted whitespaces
document.querySelectorAll("pre code").forEach(function(element,n) {
  if (element.classList.contains("xml")) {
